          ...
          >
            ...
            >
              <motion.button
                ...
                className="flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-full bg-[#FEDBFC] hover:bg-[#fca5f9] text-slate-900 font-extrabold text-xs sm:text-sm border border-[#f59ef2]/60 shadow-lg shadow-purple-500/15 hover:shadow-xl transition-all cursor-pointer"
              >
